...
void loop() {
  ...
  sampleReduxMATH = expPedal + analogRead(A19);
  sampleReduxMATH = constrain(sampleReduxMATH, 0, 1023);
  sampleRedux = map(sampleReduxMATH, 0, 1023, 18000, 1);
