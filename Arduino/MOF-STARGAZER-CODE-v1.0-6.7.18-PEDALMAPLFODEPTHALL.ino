...
void loop() {
  ...
  LFO1MATH = expPedal + analogRead(A11);
  LFO1MATH = constrain(LFO1MATH, 0, 1023);
  LFO1AMP = mapfloat(LFO1MATH, 0, 1023, 0.0f, 1.0f);
  ...
  LFO2FREQ = mapfloat(analogRead(A13), 0, 1023, 0.05f, 100.0f);
  waveform4.frequency(LFO2FREQ);

  LFO2MATH = expPedal + analogRead(A15);
  LFO2MATH = constrain(LFO2MATH, 0, 1023);
  LFO2AMP = mapfloat(LFO2MATH, 0, 1023, 0.0f, 1.0f);
  ...
  LFO3FREQ = mapfloat(analogRead(A17), 0, 1023, 0.05f, 100.0f);
  waveform5.frequency(LFO3FREQ);

  LFO3MATH = expPedal + analogRead(A18);
  LFO3MATH = constrain(LFO3MATH, 0, 1023); 
  LFO3AMP = mapfloat(LFO3MATH, 0, 1023, 0.0f, 1.0f);
